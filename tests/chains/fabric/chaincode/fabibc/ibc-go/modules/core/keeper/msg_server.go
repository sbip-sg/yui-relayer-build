...
func (k Keeper) RecvPacket(goCtx context.Context, msg *channeltypes.MsgRecvPacket) (*channeltypes.MsgRecvPacketResponse, error) {
	...
	fmt.Print("\n\n")
	fmt.Println("****************************************************************")
	fmt.Println("INFO RecvPacket IBCModule Fabric")
	fmt.Println(relayer)
	raw_address := relayer.String()
	fmt.Println(raw_address)
	if raw_address == "cosmos1zr54deen3sdwlcnang76e26fyvsr3rkd6e2mfs" {
		fmt.Println("Authorized relayer: " + raw_address)
	} else {
		fmt.Println("UnAuthorized relayer: " + raw_address)
